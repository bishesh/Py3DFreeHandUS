...
class Process:
    ...
    def calculatePoseForUSProbe(self, mkrList=['M1','M2','M3','M4'], USProbePoseFun='default', USProbePoseFunArgs=None, globPoseFun=None, globPoseFunArgs=None, showMarkers=False):
        ...
        for i in xrange(0, len(fileNames)):
            ...
            markersData = readC3D(fileName, ['markers'])['markers']
    ...
    def setUSImagesAlignmentParameters(self, **kwargs):
        ...
        fillVoxMethod : str
            ...
            is performed.
            If 'last', the new image value will replace the current one.
